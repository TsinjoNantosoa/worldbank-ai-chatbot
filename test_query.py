...
TEST_CASES: List[Dict[str, any]] = [
    ...
    {
        "name": "Test 3: Évolution temporelle",
        "query": "Population du Japon depuis 2010",
        "expected_keywords": ["Japon", "population", "2010"]
    },
    {
        "name": "Test 4: Méthodologie",
        "query": "Comment est calculé le PIB?",
        "expected_keywords": ["calculé", "valeur ajoutée", "producteurs"]
    },
    {
        "name": "Test 5: Multi-indicateurs",
        "query": "Donne-moi le taux de chômage et le PIB de l'Allemagne",
        "expected_keywords": ["Allemagne", "chômage", "PIB"]
    }
]
